...
describe("RepositoryList", () => {
  describe("RepositoryListContainer", () => {
    it("renders repository information correctly", () => {
      ...
      expect(items[0]).toHaveTextContent("1.6k");
      expect(items[0]).toHaveTextContent("21.9k");
      ...
      expect(items[1]).toHaveTextContent("69");
      expect(items[1]).toHaveTextContent("1.8k");
      expect(items[1]).toHaveTextContent("72");
